...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Restaurant manager v2`}</title>

        <meta
          name="description"
          content="Experience seamless operations with Restaurant Manager v2, your ultimate software solution for efficient and effective restaurant management."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless operations with Restaurant Manager v2, your ultimate software solution for efficient and effective restaurant management.`}
            </Text>
            <Box
